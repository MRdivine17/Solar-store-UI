...
RegisterNetEvent("shop:client:openShop", function(shopId)
    ...
    -- Trigger this when the UI opens
ESX.TriggerServerCallback("getPlayerNameFromServer", function(playerName)
    SendNUIMessage({
        type = "setPlayerName",
...
RegisterCommand("openshop", function()
    ...
    CreateThread(function()
        ...
        for _, shop in pairs(Config.Shops) do
            ...
            local ped = CreatePed(0, pedModel, coords.x, coords.y, coords.z, heading, false, true)
...
RegisterNUICallback("getPlayerName", function(_, cb)
    ESX.TriggerServerCallback("getPlayerNameFromServer", function(name)
        cb({ playerName = name })
    end)
end)
